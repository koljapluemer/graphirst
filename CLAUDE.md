Write pattern-driven, well-architectured, extendable code.
Keep functions and files single-purpose, on one abstraction layer. ACTUALLY FOLLOW Clean Code principles.
Follow the recommended reactflow patterns as closely as possibly. Do not invent custom graph stuff unless called for.
Take the scope of this app seriously. Data base may be 200k+ JSON files.
